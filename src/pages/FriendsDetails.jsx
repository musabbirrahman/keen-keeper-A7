...
import { 
  FiArrowLeft, FiBell, FiArchive, FiTrash2, 
  FiPhone, FiMessageSquare, FiVideo 
} from 'react-icons/fi';
...
const FriendsDetails = () => {
  ...
  const friend = allFriends.find((currentFriend) => currentFriend.id.toString() === id);
  ...
  if (!friend) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center bg-slate-50">
        ...
        <button onClick={() => navigate(-1)} className="mt-4 text-[#244D3F] hover:underline font-medium">
          ← Go back
        </button>
      </div>
    );
  ...
  return (
    <div className="w-full min-h-screen bg-[#F8FAFC] py-10 px-4 sm:px-6 font-sans">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4">
                <button className="flex flex-col items-center justify-center p-4 bg-[#F8FAFC] border border-gray-100 rounded-xl hover:bg-gray-100 transition-colors gap-3">
                  <FiPhone className="w-5 h-5 text-[#334155]" />
                  <span className="text-sm font-medium text-[#334155]">Call</span>
                </button>
                
                <button className="flex flex-col items-center justify-center p-4 bg-[#F8FAFC] border border-gray-100 rounded-xl hover:bg-gray-100 transition-colors gap-3">
                  <FiMessageSquare className="w-5 h-5 text-[#334155]" />
                  <span className="text-sm font-medium text-[#334155]">Text</span>
                </button>
                
                <button className="flex flex-col items-center justify-center p-4 bg-[#F8FAFC] border border-gray-100 rounded-xl hover:bg-gray-100 transition-colors gap-3">
                  <FiVideo className="w-5 h-5 text-[#334155]" />
                  <span className="text-sm font-medium text-[#334155]">Video</span>
                </button>
              </div>
            </div>
